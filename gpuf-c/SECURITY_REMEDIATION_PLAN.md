...
> 更新日期：2026-06-10 | 目标版本：v1.1.0 | 状态：P0/P1 已实现；Android SDK/Remote Worker/TLS 与 Linux sanitizer 证据已附；mobile strict gate 已按 `status:` 阻断未闭环证据；iOS raw runtime、owner sign-off、生产签名/SBOM 仍作为 release gate 跟踪
